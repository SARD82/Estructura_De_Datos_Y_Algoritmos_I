...
// Ejercicio 3 Práctica 1: Preguntar la dimensión de dos matrices, leer los datos de cada matriz y almacenarlos en dos arreglos, guardar el resultado de la suma en un tercer arreglo y mostrar dicho resultado.
...
int main(){
    ...
    printf("\nPrograma que a partir de dos matrices, las suma y muestra el resultado\n");
...
void dimensiones(){
    ...
    if (fila_matriz1 == fila_matriz2 && columna_matriz1 == columna_matriz2){
        printf("\nSe puede realizar la suma ya que son compatibles las matrices\n");
    }/*if*/ else if (columna_matriz1 != fila_matriz2){
        printf("\nNo se puede realizar la suma ya que no son compatibles las matrices\n");
        exit(0);
    }//else if
